...
public class CapInsetsViewImpl implements com.ashera.widget.IAttributable {
	...
	public void loadAttributes(String localName) {
		...
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("backgroundCapInsets").withType("dimensiondppx").withOrder(-10).withUiFlag(UPDATE_UI_REQUEST_LAYOUT_N_INVALIDATE));
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("backgroundCapInsetsTop").withType("dimensiondppx").withOrder(-10).withUiFlag(UPDATE_UI_REQUEST_LAYOUT_N_INVALIDATE));
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("backgroundCapInsetsBottom").withType("dimensiondppx").withOrder(-10).withUiFlag(UPDATE_UI_REQUEST_LAYOUT_N_INVALIDATE));
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("backgroundCapInsetsLeft").withType("dimensiondppx").withOrder(-10).withUiFlag(UPDATE_UI_REQUEST_LAYOUT_N_INVALIDATE));
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("backgroundCapInsetsRight").withType("dimensiondppx").withOrder(-10).withUiFlag(UPDATE_UI_REQUEST_LAYOUT_N_INVALIDATE));
